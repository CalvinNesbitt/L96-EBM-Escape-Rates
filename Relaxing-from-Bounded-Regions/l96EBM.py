...
class Integrator:
    ...
    def __init__(self, p=[50, 12, 0.5, 0.4, 1/180**4, 8, 270, 60, 2, 1], X_init=None, T_init=None):
    ...
    def integrate(self, how_long):
        ...
        solver_return = scipy.integrate.solve_ivp(self._rhs_dt, (t, t + how_long), IC, dense_output = True, method='LSODA')
...
class TrajectoryObserver():
    ...
    def dump(self, cupboard, name=None):
        ...
        if not os.path.exists(cupboard):
            os.makedirs(cupboard)
            print(f'Made directory at {cupboard}\n')

        save = cupboard + f'/{name}.nc'
